...
class ContestViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    - GET /api/contests/{id}/teams/ : Liste des équipes
    - GET /api/contests/{id}/challenges/ : Liste des challenges (si en cours)
    - GET /api/contests/{id}/leaderboard/ : Classement
    """
    ...
    def teams(self, request, pk=None):
        ...
        Retourne la liste des équipes dans un contest
        """
        contest = get_object_or_404(Contest, pk=pk)
    ...
    def challenges(self, request, pk=None):
        ...
        Retourne la liste des challenges (uniquement si contest en cours)
        """
        contest = get_object_or_404(Contest, pk=pk)
